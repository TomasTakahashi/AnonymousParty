package com.taka.anonymousparty.channel;
...
public class NotificationHelper extends ContextWrapper{
    ...
    private static final String CHANNEL_ID = "com.taka.anonymousparty";
    private static final String CHANNEL_NAME = "Anonymous Party";
