...
public class Chat {
    ...
    public Chat(String idChat, String idUser1, String idUser2, boolean isWriting, long timestamp, ArrayList<String> idsUsers, int idNotification) {
        this.idChat = idChat;
        ...
        this.idNotificationChat = idNotification;
    }
    ...
    public int getIdNotificationChat() {
        return idNotificationChat;
    }
